"""Test the semantic voxel loader. To be implemented."""


def test_ssc_voxel_loader() -> None:
    """Semantic voxel loader must be able to load the data in correct format."""
    print('Semantic voxel loader must be able to load the data in correct format.')
